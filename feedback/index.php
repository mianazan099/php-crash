...
?>
    ...
    <form action="<?= $_SERVER["PHP_SELF"] ?>" method="post" class="mt-4 w-75">
      <div class="mb-3">
        <label for="name" class="form-label">Name</label>
        <input type="text" class="form-control 
          <?= empty($name) && !empty($nameErr) ? "is-invalid" : null ?>"
      ...
      <div class="mb-3">
        ...
        <input type="email" class="form-control
          <?= empty($email) && !empty($emailErr) ? "is-invalid" : null ?>
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control
          <?= empty($body) && !empty($bodyErr) ? "is-invalid" : null ?>
